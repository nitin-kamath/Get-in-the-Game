...
public class newjf extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					newjf frame = new newjf();
					Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
					frame.setLocation(dim.width/2-frame.getSize().width/2, dim.height/2-frame.getSize().height/2);
					frame.setVisible(true);
					frame.setTitle("Statistics of 2017");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public newjf() {
		...
		label_1.setIcon(new ImageIcon("C:\\Users\\MAHE\\Downloads\\workspace\\DemoMain\\src\\bg_new.jpg"));
		label_1.setBounds(0, 0, 804, 341);
		    ...
		    public void actionPerformed(ActionEvent e) {		    	
		        try {
			        ...
			        if(data1.equals("All") && data2.equals("All") && data3.equals("All") && data4.equals("All")) {
			        	ResultSet rs1 = stmt.executeQuery("SELECT "+ data +",fname,lname FROM statistics,player,team where player.id=statistics.player_id and team.name=player.team_name and year=2017 order by "+data+" desc");
			        	System.out.println("connected");				        	
			        	...
			        	ResultSet rs1 = stmt.executeQuery("SELECT "+ data +",fname,lname FROM statistics,player where player.id=statistics.player_id and player.nation=\'"+data4+"\' and year=2017 order by " +data+" desc");
			        	System.out.println("connected");
				        if(count4==1) {
			        	...
			        	ResultSet rs2 = stmt.executeQuery("SELECT "+ data +",fname,lname FROM statistics,player,team where player.id=statistics.player_id and player.team_name=team.name and team.name=\'"+data2+"\' and year=2017 order by "+ data +" desc");
			        	System.out.println("connected");
				        if(count4==1) {					      
			        	...
			        	ResultSet rs1 = stmt.executeQuery("SELECT "+ data +",fname,lname FROM statistics,player,team where player.id=statistics.player_id and player.team_name=team.name and team.league_name=\'"+data1+"\' and year=2017 order by "+data+" desc");
			        	System.out.println("connected");
				        if(count4==1) {					      
			        	...
			        	ResultSet rs1 = stmt.executeQuery("SELECT "+ data +",fname,lname FROM statistics,player where player.id=statistics.player_id and player.team_name=\'"+data2+"\'and player.nation=\'"+data4+"\'  and year=2017 order by "+data+" desc");
			        	System.out.println("connected");
				        if(count4==1) {					      
			        	...
			        	ResultSet rs2 = stmt.executeQuery("SELECT "+ data +",fname,lname FROM statistics,player,team where player.id=statistics.player_id and player.team_name=team.name and team.league_name=\'"+data1+"\'and player.nation=\'"+data4+"\' and year=2017 order by "+data+" desc");
			        	System.out.println("connected");
				        if(count4==1) {					        	
					        while (rs2.next())
					        {
			        	...
			        	ResultSet rs2 = stmt.executeQuery("SELECT "+ data +",fname,lname FROM statistics,player,team where player.id=statistics.player_id and player.team_name=team.name and team.league_name=\'"+data1+"\'and team.name=\'"+data2+"\' and year=2017 order by "+data+" desc");
			        	System.out.println("connected");
				        if(count4==1) {					        	
					        while (rs2.next())
					        {
			        	...
			        	ResultSet rs2 = stmt.executeQuery("SELECT "+ data +",fname,lname FROM statistics,player,team where player.id=statistics.player_id and player.team_name=team.name and team.league_name=\'"+data1+"\'and team.name=\'"+data2+"\'and player.nation=\'"+data4 +"\'and year=2017 order by "+data+" desc");
			        	System.out.println("connected");
				        if(count4==1) {					        	
					        while (rs2.next())
					        {
			        	...
			        	String arr[]=data3.split(" ",2);
			        	ResultSet rs2 = stmt.executeQuery("SELECT "+ data +",fname,lname FROM statistics,player,team where player.id=statistics.player_id and player.team_name=team.name and FNAME=\'"+arr[0]+"\'and LNAME=\'"+arr[1]+"\' and year=2017 order by "+data+" desc");
			        	System.out.println("connected");
				        if(count4==1) {				        	
					        while (rs2.next())
					        {
